...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan 28 15:16:58 2024
...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan 28 14:53:24 2024
...
class Simulation_Model:
    ...
    def generate_arrivals(self):
        ...
        while True:
            ...
            #Check the last information regarding queue size
            #If it is greater than the capacity then 
            #Do not accept that customer
            capacity = True
            
            if len(G.num_in_queue) == 0:
                capacity = True
            elif G.num_in_queue[-1] < G.K:
                capacity = True
            else:
                capacity = False
